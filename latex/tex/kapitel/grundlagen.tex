...
Für die Clipped \ac{ReLU} Transferfunktion sind die vier Befehle relevant: VPXOR, VPACKSSWB, VPMAXSB, VPERMQ. Die nächsten vier aufgelisteten Befehle in der \autoref{table:nnueInstructions}, sind Teil des Akkumulators.

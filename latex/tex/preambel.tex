...
\usepackage[font={sf,footnotesize},labelfont={footnotesize,bf}]{subcaption} % Beschriftungen
...
\usepackage{pgfplots}             % erweiterung für tikz um graphen zu erstellen
\usepackage{chessboard}           % Schachbrett anzeigen
...
% Die Titel im biblatex Literaturverzeichnis soll immer in Anführungszeichen stehen
\DeclareFieldFormat
  [article,inbook,incollection,inproceedings,patent,thesis,unpublished,techreport,misc,book,online]
  {title}{\mkbibquote{#1}}
